...
export function ConnectionAlert() {
  ...
  const messages = {
    [ConnectionState.Connecting]: 'Connecting to voice room...',
    [ConnectionState.Reconnecting]: 'Reconnecting to voice room...',
    [ConnectionState.SignalReconnecting]: 'Reconnecting to voice room...',
  };
  ...
  return (
    ...
    >
      ...
      <span>{messages[connectionState] || 'Connecting...'}</span>
    </div>
  );
}
