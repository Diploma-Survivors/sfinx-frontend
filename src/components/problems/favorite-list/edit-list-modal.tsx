...
export function EditListModal({
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      toastService.success(t("list_updated"));
      onSuccess?.();
      onClose();
    } catch (error) {
      toastService.error(t("update_failed"));
    } finally {
      ...
      <DialogContent onOpenAutoFocus={(e) => e.preventDefault()}>
        ...
        <div className="space-y-4 py-4">
          <div className="space-y-2">
            <Label htmlFor="edit-list-name">{t("title")}</Label>
          ...
          <div className="space-y-2">
            <Label htmlFor="edit-list-description">{t("description")}</Label>
            <div className="relative">
              <textarea
