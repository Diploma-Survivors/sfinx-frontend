          ...
          {lists.map((list) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0 flex flex-col gap-1.5">
                <h4 className="font-medium text-sm truncate leading-none">
                  {list.name}
                </h4>
                <div className="flex">
                  <Badge
                    variant="secondary"
                    className="rounded-md px-1.5 py-0 text-[10px] font-normal h-5"
                  >
                    {t("count_problems", { count: list.problems?.length || 0 })}
                  </Badge>
                  <Badge
                    variant="secondary"
                    className="ml-1 rounded-md px-1.5 py-0 text-[10px] font-normal h-5 flex items-center gap-1"
                  >
