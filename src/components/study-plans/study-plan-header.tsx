...
import {
  EnrollmentStatus,
  StudyPlanDifficulty,
  type StudyPlanDetailResponseDto,
  type StudyPlanProgressResponseDto,
        ...
        <div className="flex-1 space-y-6">
          <div className="flex flex-wrap gap-3 items-center">
            {plan.isPremium && (
              <Badge
                variant="secondary"
                className="bg-amber-500/10 text-amber-500 border-amber-500/20 font-mono text-xs uppercase"
              >
            ...
            <Badge
              variant="outline"
              className="text-sm bg-secondary/80 text-secondary-foreground border-border"
            >
            ...
            {isEnrolled ? (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      {t("problems_solved", "problems solved")}
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-xs text-center text-muted-foreground">
                  {t(
                    "enroll_desc",
                    "Join thousands of developers mastering these concepts.",
                  )}
                </p>
              </div>
            )}
