      ...
      >
          ...
          <CardFooter className="flex flex-col gap-3 p-6 pt-0 bg-muted/10">
            <motion.div variants={itemVariants} className="w-full space-y-3">
              <Link href="/settings?tab=billing" className="w-full block">
                <Button
                  size="lg"
                  className="w-full bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 text-white shadow-lg shadow-green-500/25 transition-all duration-300 transform hover:-translate-y-0.5"
                >
                  <Receipt className="mr-2 h-5 w-5" />
                  {t("view_billing_history", {
                    defaultValue: "View Billing & History",
                  })}
                </Button>
              </Link>
        ...
        >
          {t("auto_redirect_hint", {
            defaultValue: "Check your email for the receipt.",
          })}
        </motion.p>
      </motion.div>
    </div>
